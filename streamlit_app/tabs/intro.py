...
def run():
    ...
    st.markdown(
        ...
        NB : l’idée originale était d’utiliser un jeu de données de paris pour voir si le modèle permettait de gagner de l’argent, de voir à quel moment il était plus efficace de parier, etc. Malheureusement nous n’avons pas trouvé de jeu de donnés complet de pari permettant mettre en place ces idées. 
        ...
        Selon l’__[ARJEL](https://anj.fr/sites/default/files/2022-04/ANJ_Rapport_e%CC%81co_2021.pdf)__ , le produit brut des jeux (c.a.d. les bénéfices des bookmakers) des paris sportifs (hors courses hippiques) en France représentait 472 millions d’euros en 2017 et 1,3 milliards en 2021 pour un total de mises de 7,9 milliards d’euros (2,5 milliards en 2017)!
    ...
    st.markdown(
        ...
        Les côtes proposées par le bookmaker sont évidemment inférieures aux cotes calculées grâce aux probabilités de victoire. 
        ...
        Ainsi, pour ce même match, les côtes affichées sont de :
        ...
        Pour la formule 1, l’idée est la même, le bookmaker établit le pourcentage de victoires de chaque pilote et calcule la côte associée.
        ...
        Les essais se déroule en 3 séances : FP1, FP2 et FP3. Ce sont des sessions d'essais libres permettant aux équipes de tester leurs voitures le vendredi et le samedi.

        La séance de qualification se déroule en 3 étapes : Q1, Q2 et Q3 (format actuelle mise en place en 2006). Durant la Q1, tous les pilotes s'affrontent pour réaliser le meilleur temps au tour. Les 15 meilleurs pilotes participeront à la Q2 et les derniers pilotes seront éliminés. Même principe pour la Q2, où seuls les 10 meilleurs pilotes passeront à la Q3. C’est cette ultime session de qualification qui détermine l’ordre sur la grille de départ, le meilleur temps de la Q3 démarrera la course en pole position, le deuxième temps en seconde place, etc.
